...
class ChewingDataset(Dataset):
    ...
    def __init__(
        ...
        # ❌ OLD (hardcoded drive path – removed)
        # self.feature_root = Path("/content/drive/...")
    ...
    def __getitem__(self, idx):
        ...
        # ==========================================
        # ✅ DIRECT FEATURE PATH (NO KAGGLE LOGIC)
        # ==========================================
        ...
        return {
            ...
            "det_y": torch.ones((t,), dtype=torch.long),  # unchanged
...
#     # ❌ OLD (wav based)
#     # return [parse_recorded_filename(p) for p in sorted(root.glob("*.wav"))]
#     # ✅ NEW (npy features based)
#     return [parse_recorded_filename(p.with_suffix(".wav")) for p in sorted(root.glob("*.npy"))]
